...
window.showElements = function () {
    let markers = window.vue.$children[0].$refs.layout.$refs.marker.$refs.markerManager.markerManager.manager;
    let graphics = window.graphicManager.manager;
    let layers = window.vue.$children[0].$refs.layout.$refs.marker.$refs.layerManager.json;
